...
/* 
            ...
            if (user) {
                if (user.role === 0) {
                    setOptions([
                        ...
                        {
                            to: `/products/:category_id/1`, title: "Shop",
                            icon:
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    setOptions([
                        ...
                        {
                            to: '/seller-products', title: "Our Products", icon:
                        ...
                        {
                            to: '/creatorPanel', title: "Panel Creator",
                            icon:
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                    ...
                    setOptions([
                        ...
                        {
                            to: '/panel', title: "Panel Admin", icon:
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 11-3 0m3 0a1.5 1.5 0 10-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 01-3 0m3 0a1.5 1.5 0 00-3 0m-9.75 0h9.75" />
                                </svg>
    ...
    return (
        <nav className=" w-full top-100 bg-slate-500">
            <div>hola</div>
                ...
                {options?.map((each, index) =>
                    <li className="py-2 w-full flex justify-center md:justify-start bg-gray-200" key={index}>
                        <Anchor className="w-full" onClick={each.onClick} key={index} to={each.to}>
                            <div className='text-black mx-3 flex font-poppins text-center md:text-left text-[18px] font-semibold leading-6 rounded-lg cursor-pointer hover:bg-gradient-to-r hover:from-gray-300 hover:to-gray-400 p-2'>
